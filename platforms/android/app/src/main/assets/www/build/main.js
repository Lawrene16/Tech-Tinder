...
var SigninPage = (function () {
    ...
    SigninPage.prototype.onSubmit = function () {
        ...
        this.authService.signInWithEmail(user)
            ...
            if (isLogged) {
                console.log(user);
                _this.firedata.ref('/users').orderByChild('mmmm').once('value', function (snapshot) {
                    var result = snapshot.val();
                    var temparr = [];
                    for (var key in result) {
                        temparr.push(result[key]);
                    }
                    temparr.forEach(function (fireuser) {
                        ...
                        if (user.email == fireuser.email) {
                            ...
                            if (fireuser.userType == "recruiter") {
                                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_7__tabsclient_tabsclient__["a" /* TabsclientPage */]);
                            }
                            else if (fireuser.userType == "freelancer") {
                                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__tabsfreelancer_tabsfreelancer__["a" /* TabsfreelancerPage */]);
                            }
                        }
                    });
                });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_chat_chat_service__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_base_service__ = __webpack_require__(90);
...
var AuthService = (function (_super) {
    ...
    AuthService.prototype.resetPassword = function (email) {
        return new Promise(function (resolve, reject) {
            __WEBPACK_IMPORTED_MODULE_5_firebase__["auth"]().sendPasswordResetEmail(email).then(function (res) {
                resolve(res);
            }).catch(function (err) {
                reject(err);
                // console.log(err);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_base_service__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2__ = __webpack_require__(85);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ShortlistedPage = (function () {
    ...
    ShortlistedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-shortlisted',template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/shortlisted/shortlisted.html"*/'<ion-header>\n    <ion-navbar color="light">\n      <ion-buttons start>\n        <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      </ion-buttons>\n  \n      <ion-buttons end>\n        <button ion-button icon-only (click)="openSecondModal()">\n            <ion-icon  class="icon ion-home custom-icon" name="ios-search"></ion-icon>\n        </button>\n    </ion-buttons>\n      <ion-title>Shortlisted</ion-title>\n    </ion-navbar>\n  </ion-header>\n  \n  \n  <ion-content>\n  \n      <ion-list>\n  \n  \n        <ion-card>\n          <ion-item  (click)="gotoChat(user)">\n            <ion-avatar item-left>\n              <img src="assets/one.jpg">\n            </ion-avatar>\n            <b>Edung Divine (Expert iOS Developer)</b>\n            <p>Have you started to make the designs</p>\n          </ion-item>\n  \n        </ion-card>\n  \n  \n        <ion-card>\n          <ion-item  (click)="gotoChat(user)">\n            <ion-avatar item-left>\n              <img src="assets/three.jpg">\n            </ion-avatar>\n            <b>Edung Divine (Expert iOS Developer)</b>\n            <p>Have you started to make the designs</p>\n          </ion-item>\n  \n        </ion-card>\n        <ion-card>\n          <ion-item  (click)="gotoChat(user)">\n            <ion-avatar item-left>\n              <img src="assets/three.jpg">\n            </ion-avatar>\n            <b>Edung Divine (Expert iOS Developer)</b>\n            <p>Have you started to make the designs</p>\n          </ion-item>\n  \n        </ion-card>\n        </ion-list>\n  </ion-content>\n  '/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/shortlisted/shortlisted.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_auth_service__ = __webpack_require__(27);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FreelancersPage = (function () {
    function FreelancersPage(navCtrl, keyboard, authService, storage, 
        // private geolocation: Geolocation,
        loadingCtrl) {
        this.navCtrl = navCtrl;
    ...
    FreelancersPage.prototype.loadMap = function () {
        ...
        // this.geolocation.getCurrentPosition().then((resp) => {
        var latLng = new google.maps.LatLng(6.529843199999999, 3.3636352);
        var mapOptions = {
            center: latLng,
            zoom: this.zoomvalue,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase_app__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase_app___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_firebase_app__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tabsfreelancer_tabsfreelancer__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modal_modal__ = __webpack_require__(156);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobsPage = (function () {
    ...
    JobsPage.prototype.ionViewDidLoad = function () {
        ...
        this.geolocation.getCurrentPosition().then(function (resp) {
            _this.presentToast(resp.coords.latitude);
        }).catch(function (err) {
            _this.presentToast('Error getting location' + err.message);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modal_modal__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_firebase__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_imageprovider_imageprovider__ = __webpack_require__(285);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfilefreelancerPage = (function () {
    function ProfilefreelancerPage(navCtrl, modalCtrl, keyboard, imagehandler, loadingCtrl, toastCtrl, 
    ...
    ProfilefreelancerPage.prototype.selectImage = function () {
        var _this = this;
        this.imagehandler.selectImage().then(function (res) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ImageproviderProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_camera__ = __webpack_require__(286);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/*
  ...
  and Angular DI.
*/
var ImageproviderProvider = (function () {
    function ImageproviderProvider(http, camera) {
        this.http = http;
        this.camera = camera;
        console.log('Hello ImageproviderProvider Provider');
    }
    ImageproviderProvider.prototype.selectImage = function () {
        var _this = this;
    ...
    ImageproviderProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_camera__["a" /* Camera */]])
    ], ImageproviderProvider);
    return ImageproviderProvider;
}());
...
var ResetpasswordPage = (function () {
    function ResetpasswordPage(navCtrl, loadingController, toastCtrl, authService, navParams) {
        this.navCtrl = navCtrl;
    ...
    ResetpasswordPage.prototype.resetPassword = function () {
        var _this = this;
        var load = this.loadingController.create({
        ...
        this.authService.resetPassword(this.email).then(function () {
            load.dismiss();
            _this.navCtrl.pop();
            _this.presentToast("Password reset link has been sent to your email");
        }).catch(function (err) {
            _this.presentToast(err);
            load.dismiss();
        });
    ...
    ResetpasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-resetpassword',template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/resetpassword/resetpassword.html"*/'<!--\n  Generated template for the ResetpasswordPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Reset Password</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n    <ion-input [(ngModel)]="email" type="email" placeholder="Enter email to send password reset link"></ion-input>\n\n    <p align="center"><button (click)="resetPassword()" ion-button type="submit" class="btn success">Reset Password</button></p>\n\n</ion-content>\n'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/resetpassword/resetpassword.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ToastController */],
...
var JoblistPage = (function () {
    ...
    JoblistPage.prototype.loadJobs = function () {
        var _this = this;
        this.joblist = [];
        this.firedata.ref('/jobs').orderByChild('mm').once('value', function (snapshot) {
            ...
            temparr.forEach(function (job) {
                _this.joblist.push(job);
            });
    ...
    JoblistPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-joblist',template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/joblist/joblist.html"*/'<ion-header>\n    <ion-navbar color="light">\n      <ion-buttons start>\n        <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      </ion-buttons>\n  \n     \n    <ion-buttons end>\n        <button ion-button icon-only (click)="openSecondModal()">\n            <ion-icon  class="icon ion-home custom-icon" name="ios-search"></ion-icon>\n        </button>\n    </ion-buttons>\n      <ion-title>Find Jobs</ion-title>\n    </ion-navbar>\n  </ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-item *ngFor="let job of joblist">\n      <div style="margin-top: 10px">\n          <h2 style="color: #287AB0">{{job.title}}</h2>\n          <ion-icon style="position: absolute; z-index: 5;\n          top: 20px;\n           right: 20px;" name="ios-heart-outline"></ion-icon>\n      </div>\n      <div><b>{{job.jobtype}}</b> - Just now</div>\n      <br>\n      <div>\n          <p>Skill Level</p>\n          <p>{{job.skilllevel}}</p>\n          <p style="position: absolute; z-index: 5;\n          bottom: 20px;\n           right: 20px;">3/5(19)</p>\n      </div>\n      \n      <div></div>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/joblist/joblist.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
    ], JoblistPage);
    return JoblistPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_auth_auth_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pipes_capitalize_capitalize__ = __webpack_require__(622);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_profilefreelancer_profilefreelancer__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_freelancers_freelancers__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_shortlisted_shortlisted__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_chats_chats__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_setupprofile_setupprofile__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_modal_modal__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_detailsfreelancer_detailsfreelancer__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_postjob_postjob__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_profileclient_profileclient__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_joblist_joblist__ = __webpack_require__(290);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_34__pages_postjob_postjob__["a" /* PostjobPage */],
                __WEBPACK_IMPORTED_MODULE_35__pages_profileclient_profileclient__["a" /* ProfileclientPage */],
                __WEBPACK_IMPORTED_MODULE_37__pages_resetpassword_resetpassword__["a" /* ResetpasswordPage */],
                ...
                __WEBPACK_IMPORTED_MODULE_36__pages_joblist_joblist__["a" /* JoblistPage */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_38__providers_imageprovider_imageprovider__["a" /* ImageproviderProvider */],
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_base_service__ = __webpack_require__(90);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_auth_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_user_model__ = __webpack_require__(157);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var CustomLoggedHeaderComponent = (function (_super) {
    ...
    CustomLoggedHeaderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'custom-logged-header',template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/components/custom-logged-header/custom-logged-header.component.html"*/'<ion-navbar>\n    <button ion-button menuToggle="user-menu">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n\n  <ion-title>\n\n    <ion-item detail-none no-lines color="transparent" *ngIf="user; else titleTemplate">\n      <!-- vai chamar o ng-template #titleTemplate -->\n      <ion-avatar item-start>\n        <img [src]="user.photo || \'assets/imgs/no-photo.jpg\' ">\n      </ion-avatar>\n      {{ title }}\n    </ion-item>\n\n    <ng-template #titleTemplate>\n      {{ title }}\n    </ng-template>\n  \n  </ion-title>\n\n  <ion-buttons end>\n    <button ion-button icon-only (click)="onLogOut()">\n      <ion-icon name="exit"></ion-icon>\n    </button>\n  </ion-buttons>\n</ion-navbar>'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/components/custom-logged-header/custom-logged-header.component.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_joblist_joblist__ = __webpack_require__(290);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/app/app.html"*/'<ion-menu persistent="true" [content]="content" type="overlay">\n    <ion-header no-border>\n      <ion-toolbar>\n                <div class="container">\n                    <img class="userimage" src="assets/user.png">\n                    <b class="user-name">{{fullname}}</b>\n                    <div class="user-mail">{{email}}</div>\n                    <br>\n                    <br>\n                   \n                </div>\n  \n      </ion-toolbar>\n    </ion-header>\n    \n    <ion-content>\n  \n        <ion-list>\n          <button ion-item menuClose *ngFor="let p of pages" (click)="openPage(p)">\n              <ion-icon item-start [name]="p.icon"></ion-icon>\n              <!-- <ion-icon item-start [name]="p.icon" [color]="isActive(p)"></ion-icon> -->\n              {{ p.title }}\n            </button>\n        </ion-list>\n  \n  <!-- \n              <ion-list>\n          <button ion-item menuClose *ngFor="let p of pages" (click)="openPage(p)">\n              <ion-icon item-start [name]="p.icon"></ion-icon>\n              {{ p.title }}\n            </button>\n        </ion-list> -->\n      </ion-content>\n  </ion-menu>\n  \n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/app/app.html"*/
        }),
...
var ProgressBarComponent = (function () {
    ...
    ProgressBarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'progress-bar',template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/components/progress-bar/progress-bar.component.html"*/'<div class="progress-outer">\n  <div class="progress-inner" [style.width]="progress + \'%\'">\n    <!-- o width vai aumentando conforme o número do progress aumenta\n       e vai aumentar percentualmente por causa da concatenação (%) -->\n    {{ progress }}%\n  </div>\n</div>'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/components/progress-bar/progress-bar.component.html"*/
        }),
        __metadata("design:paramtypes", [])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_user_model__ = __webpack_require__(157);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserInfoComponent = (function () {
    ...
    UserInfoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'user-info',template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/components/user-info/user-info.component.html"*/'<div *ngIf="user">\n  <ion-avatar [ngClass]="{\'custom-background\': isMenu}">\n    <img class="round" [src]="user.photo || \'assets/imgs/no-photo.jpg\' ">\n  </ion-avatar>\n  <h2 text-center> {{ user.name }}</h2>\n  <p text-center> @{{ user.username }}</p>\n</div>'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/components/user-info/user-info.component.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], UserInfoComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_user_model__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_user_profile_user_profile__ = __webpack_require__(291);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var TabsclientPage = (function () {
    ...
    TabsclientPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/tabsclient/tabsclient.html"*/'<ion-tabs>\n    <ion-tab [root]="tab1Root" tabTitle="Freelancers" tabIcon="ios-people"></ion-tab>\n    <ion-tab [root]="tab2Root" tabTitle="Chats" tabIcon="ios-chatbubbles"></ion-tab>\n    <ion-tab [root]="tab3Root" tabTitle="ShortListed" tabIcon="ios-contacts"></ion-tab>\n  </ion-tabs>'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/tabsclient/tabsclient.html"*/,
        }),
        __metadata("design:paramtypes", [])
    ], TabsclientPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chats_chats__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jobs_jobs__ = __webpack_require__(282);
...
var TabsfreelancerPage = (function () {
    ...
    TabsfreelancerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/tabsfreelancer/tabsfreelancer.html"*/'<ion-tabs>\n    <ion-tab [root]="tab1Root" tabTitle="Jobs" tabIcon="ios-briefcase"></ion-tab>\n    <ion-tab [root]="tab2Root" tabTitle="Chats" tabIcon="ios-chatbubbles"></ion-tab>\n    <ion-tab [root]="tab3Root" tabTitle="Profile" tabIcon="ios-contact"></ion-tab>\n</ion-tabs>'/*ion-inline-end:"/Users/villifixinc/Desktop/Tech-Tinder/src/pages/tabsfreelancer/tabsfreelancer.html"*/,
        }),
        __metadata("design:paramtypes", [])
    ], TabsfreelancerPage);
